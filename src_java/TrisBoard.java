...
public class TrisBoard {
  ...
  private static int DEFAULT_WIDTH = 16;  // Should not be larger than 32

  // Current board height and width
  private int iBoardHeight = -1;  // aka DEPTH
  ...
  //   the current rotation of the block that is currently dropping.
  private int iCurrentBlockRotation = 0;

  // An integer array that represents the current Tris board.
  ...
  public TrisBoard(int iDefaultHeight, int iDefaultWidth) {
  ...
  private int[] iaOverlayBlock() {
    // Returns an integer array representing the Tris board, with the current
